...
import net.insomniakitten.atmosphere.block.BlockSolarPanel;
...
import net.insomniakitten.atmosphere.util.dev.BlockStateFactory;
...
public final class AtmosphereRegistry {
    ...
    public static void onBlockRegistry(RegistryEvent.Register<Block> event) {
        ...
        GameRegistry.registerTileEntity(TileSolarPanel.class, TileSolarPanel.ID.toString());
        BLOCKS.begin(event).register(new BlockSolarPanel().setRegistryName("solar_panel"));
    }
